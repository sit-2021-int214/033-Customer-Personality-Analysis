...
View(movies)
#Ans. 19th movies name is "Avengers: Infinity War"


#Which year is most released movies (In this question can using observation data, 
#not necessary to used command to find answer)
View(movies)
#Ans. 2017 and 2021 are most released movies